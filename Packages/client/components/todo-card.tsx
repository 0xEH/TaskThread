        ...
        >
          <CardHeader>
            <div className='flex items-center justify-start gap-2 mb-2'>
              <div
                className={`px-2 w-auto md:px-4 py-1 flex items-center justify-center rounded-full shadow-sm border ${
                  statusColors[todo.status]
                }`}
                key={`status-${index}`}
              >
                <h1 className='text-xs'>{dictionaries.task[todo.status]}</h1>
              </div>
              <div
                className={`px-2 w-auto md:px-4 py-1 flex items-center justify-center rounded-full shadow-sm border ${
                ...
                key={`priority-${index}`}
              >
                <h1 className='text-xs'>{dictionaries.task[todo.priority]}</h1>
              </div>
            </div>
